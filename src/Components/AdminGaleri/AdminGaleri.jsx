...
const AdminGaleri = () => {
  ...
  const onSearchGaleri=useCallback((e)=>{
    ...
    return (
      <div className='admin-container'>
        ...
        <div style={{display:'flex',marginBottom:'20px',justifyContent:'flex-end',backgroundColor:'#ffffff',alignItems:'center',paddingTop:'20px',paddingBottom:'20px',borderRadius:'8px'}}>
        

          <div style={{marginRight:'20px',width:'200px'}}>
          <input  placeholder='Cari Judul Galeri'  value={searchGaleri} onChange={onSearchGaleri} style={{marginRight:'20px',height:'30px',width:'200px',backgroundColor:'#F4F4F4',borderRadius:'4px',border:'1px solid #C4C4C4',outline:'none',fontSize:'15px'}}/>
          </div>
        ...
        <Dialog open={openForm} onClose={() => SetOpenForm(false)}>
          ...
          <DialogContent>
            ...
            >
              ...
              <div style={{width:'100%',height:'300px',borderRadius:'8px',border:'1px solid #ECECEC',display:'flex',justifyContent:'center',alignItems:'center',overflow:'hidden'}}>
                {
                  selectedFile ?       <div 
