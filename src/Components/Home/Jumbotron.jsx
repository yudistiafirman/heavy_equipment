  ...
  const content = [
    {
      ...
      smalltext:
        "HEC sebagai perusahaan jasa layanan support alat berat profesional akan menangani semua kebutuhan anda",
      description:
    ...
    },
    {
      ...
      smalltext:
        "HEC selalu siap dan selalu ada sebagai solusi semua kebutuhan alat berat anda  ",
      description:
    ...
    },
    {
      ...
      smalltext:
        " HEC turut andil dalam meningkatkan SDM Indonesia dengan program pendidikan dan pelatihan alat berat yang didukung dengan fasilitas mumpuni",
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Duis mollis, est non commodo luctus, nisi erat porttitor ligula.",
      button: "Buy now",
      image: J3,
              ...
              <div className="jumbotronContent">
                <div className="campaign">
                  <div className="textWithBtn">
                    ...
                    <div className="heroSmallText">{item.smalltext}</div>
                  </div>
                </div>
              </div>
            </div>
