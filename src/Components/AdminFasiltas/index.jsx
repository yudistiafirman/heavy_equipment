...
const AdminFasilitas = () => {
  ...
  const onDeleteList=()=>{
      axios.delete(`${apiUrl}/fasilitas/delete?id=${selected}`).then((response)=>{
    ...
    <div className='admin-container'>
      ...
      <Box sx={{ width: '100%', height: '100%' }}>
        <Paper sx={{ width: '100%', mb: 2 }}>
          <EnhancedTableToolbar onDeleteList={onDeleteList} numSelected={selected.length} />
          <TableContainer>
            <Table
              sx={{ minWidth: 1000 }}
                    ...
                    return (
                      <TableRow hover tabIndex={-1} key={index}>
                        ...
                        <TableCell
                          ...
                          scope='row'
                          padding='none'
                          style={{fontSize:'15px',fontWeight:'800',color:'#071244'}}
                        >
                          {row.name}
                        </TableCell>
                        <TableCell
                          ...
                          align='left'
                        >
                          <div onClick={()=>SetShowImages(`${apiUrl}/${row.image_1}`)}  style={{width:'100px',height:'100px',borderRadius:'8px',overflow:'hidden',border:'1px solid #C4C4C4'}}>
                            <div
                              style={{
                                width: '100%',
                                height: '100%',
                        ...
                        >
                            ...
                            <div onClick={row.image_2 !== null ? ()=>SetShowImages(`${apiUrl}/${row.image_2}`) : null}  style={{width:'100px',height:'100px',borderRadius:'8px',overflow:'hidden',border:'1px solid #C4C4C4'}}>
                              <div
                                style={{
                                  width: '100%',
                                  height: '100%',
                        ...
                        <TableCell
                          ...
                          onClick={row.image_3 !== null ? ()=>SetShowImages(`${apiUrl}/${row.image_3}`) : null} 
                        >
                        
                            <div style={{width:'100px',height:'100px',borderRadius:'8px',overflow:'hidden',border:'1px solid #C4C4C4'}}>
                              <div
                                style={{
                                  width: '100%',
                                  height: '100%',
                        ...
                        >
                            <div style={{width:'250px',alignContent:'center'}}>
