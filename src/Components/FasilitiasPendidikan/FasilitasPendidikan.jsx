            ...
            </div>
            {
              fasilitasData.map((v,i)=>{
                ...
                >
                  ...
                  <Typography style={{fontSize:'18px',fontWeight:'800', color:'#6B7280',fontFamily:'"inter",sans-serif',lineHeight:'24.3px'}}>{v.name}</Typography>
                </AccordionSummary>
                <AccordionDetails>
                <div className='fasilitasListImageContainer'>
                    <div className='fasilitasImage'
                    ...
                    onClick={v.image_2 !== null ? ()=>SetShowImages(`${apiUrl}/${v.image_2}`): null }
                    style={{
                      backgroundImage:v.image_2 !== null && `url(${apiUrl}/${v.image_2})`,
                      backgroundRepeat:'no-repeat',
                      backgroundSize: "cover",
                      backgroundPosition: "center"
                    }}
                    ...
                    <div
                  className='fasilitasImage'
                  onClick={v.image_3 !== null ? ()=>SetShowImages(`${apiUrl}/${v.image_3}`): null }
                  style={{
                    backgroundImage:v.image_3 !== null && `url(${apiUrl}/${v.image_3})`,
                    backgroundRepeat:'no-repeat',
                    backgroundSize: "cover",
                    backgroundPosition: "center"
                  }}
                  ...
                  <Typography style={{fontSize:'15px',fontWeight:'400', color:'#6B7280',fontFamily:'"inter",sans-serif',lineHeight:'22px',textAlign:'justify'}}  className='latarContent'>
                  {v.descriptions}
                  </Typography>
                </AccordionDetails>
              </Accordion>
